About photo-tagger-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/photo-tagger-feedstock/blob/main/LICENSE.txt)

Home: https://juliobs.com/projects/photo-tagger/

Package license: MIT

Summary: CLI tool to describe photos and add keywords using AI

Development: https://github.com/jbsilva/photo-tagger
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/photo-tagger-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/photo-tagger-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
Installing `photo-tagger` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
mamba repoquery search photo-tagger --channel conda-forge

# List packages depending on `photo-tagger`:
mamba repoquery whoneeds photo-tagger --channel conda-forge
...
Updating photo-tagger-feedstock
===============================

If you would like to improve the photo-tagger recipe or build a new
...
Note that all branches in the conda-forge/photo-tagger-feedstock are
